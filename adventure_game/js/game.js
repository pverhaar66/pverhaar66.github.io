...
function Level1() {
	...
	chap.innerHTML = ' U woke up in a bed , seein the flashbacks of  youre city being destroyed by the Primal of all Bahamut, then u feel the wind through the open window and look outside and see that the battle have passed , you hear a voice of and old man say , aah youre finally awake boy, you ask how long it has been since Bahamuts attack , the old man replys  Bahamut last appearnce has been 5 years ago boy';
...
function level3() {
	...
	var opt2 = document.getElementById('option2');
	var opt3 = document.getElementById('option3');
	chap.innerHTML = ' Welcome to Big Steves Blacksmith . you see  holy dagger like wep and a great sword in the showcase, i guess u came here for a weapon huh well you came to the right place, i got an damn fine weapon just for you';
